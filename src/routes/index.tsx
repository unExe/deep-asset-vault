    ...
    <div className="min-h-screen bg-vault-bg text-vault-fg-muted">
      ...
      <main>
        ...
        >
          ...
          >
            <motion.div variants={rise} className="mb-8 border border-vault-hairline bg-vault-overlay px-3 py-1 rounded-full">
            ...
            <motion.h1 variants={rise} className="text-5xl md:text-7xl font-bold text-vault-fg tracking-tighter mb-6">
              The Vault<span className="text-vault-fg-muted">.unExe</span>
            </motion.h1>

            <motion.p variants={rise} className="max-w-lg text-lg leading-relaxed mb-10">
            ...
            <motion.dl variants={rise} className="mt-14 grid grid-cols-3 gap-8 sm:gap-14">
